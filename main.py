...
game_over = False
score.all_time_best_score_header()
score.all_time_best_score_number()
...
def game(game_over):
    while not game_over:
        ...
        if snake.snake_body[0].distance(target) < 15: #if the snake head is within 15 pixels of the target
            score.targets_scored += 1
            if score.targets_scored > score.all_time_best:
                score.all_time_best = score.targets_scored
                score.all_time_best_score_number()
